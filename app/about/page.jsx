...
export default function About() {
  return (
    <>
      <Head>
        <title>
          About R & R Hotel Consultants | Expert Hospitality Consultancy
        </title>
        <meta
          name="description"
          content="R & R Hotel Consultants brings decades of hospitality expertise to hotels of all sizes. We partner with hoteliers to boost profitability and guest satisfaction through tailored solutions."
        />
        <meta
          name="keywords"
          content="hotel consultants, hospitality experts, hotel profitability, guest satisfaction, hotel operations"
        />
      ...
      <main className="min-h-screen bg-gray-50">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mt-4">
                  ...
                  strategies. Our mission? To empower hoteliers like you with
                  the tools, insights, and solutions needed to thrive in an
                  ...
                  operational excellence. What sets us apart is our commitment
                  to partnership—we don’t just consult, we collaborate. Your
        ...
        <section className="py-16 bg-gray-100 text-center">
          <div className="container mx-auto px-6">
            <h3 className="text-3xl text-gray-900 mt-2 font-serif mb-10">
              Our Team
            </h3>
            {/* <div className="mt-12 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-6 justify-center mx-auto"> */}
            {/* <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-12 mx-auto"> */}
            <div className="flex align-items-center justify-center flex-wrap">
              <motion.div
                initial={{ y: 100, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{
                ...
                viewport={{ once: true }}
                className="bg-white lg:w-1/3 md:w-1/2 w-11/12 p-6 rounded-lg shadow-md transition-transform duration-500 hover:scale-105 mx-5 mb-4 md:mb-0"
              >
                <Image
                  src="/asset/user2.jpg"
                  alt="Team Member 1"
              ...
              >
                <Image
                  ...
                  width={150}
                  height={150}
                  className="rounded-full mx-auto h-36"
                />
                <h3 className="mt-4 text-lg font-semibold text-gray-900">
                  Raj Patel
                </h3>
