...
export default function VendorDirectory() {
  return (
    <>
      <Head>
        <title>Hotel Consulting Services | R & R Hotel Consultants</title>
        <meta
          name="description"
          content="Comprehensive hotel consulting services including operations, revenue management, guest experience, marketing, property development, and sustainability solutions for hospitality businesses."
        />
        <meta
          name="keywords"
          content="hotel consulting services, operational excellence, revenue management, guest experience, hotel marketing, property development, sustainability"
        />
          ...
          <div className="mt-12 space-y-10 max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            >
              ...
              <div className="md:ml-6 mt-4 md:mt-0">
                ...
                <p className="mt-2 text-sm sm:text-base">
                  Create memorable stays through innovative service design,
