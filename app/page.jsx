        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="mt-3 text-gray-600 text-lg">
                Equipped with exercise machines, offering massages, facials, and
                treatments.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-gray-600 text-lg">
                Indoor or outdoor pools for leisure or exercise, with additional
                spa services.
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center">
          ...
          >
            <h2 className="text-[#AB8A62] text-lg font-medium uppercase tracking-widest font-serif flex items-center justify-center md:justify-start gap-2">
              <span className="border-t border-[#AB8A62] w-8"></span>R & R Hotel
              Consultants
              <span className="border-t border-[#AB8A62] w-8"></span>
            </h2>
            ...
            <p className="text-lg text-gray-700 mt-4 italic">
              "Welcome to R & R Hotel Consultants your trusted partner in hotel
              success. We specialize in transforming hospitality businesses
              through expert consulting services tailored to your unique needs.
              From boosting operational efficiency and enhancing guest
              experiences to maximizing revenue and profitability, our team of
              seasoned industry professionals is here to guide you every step of
              the way. Whether you’re launching a new property, revitalizing an
              existing one, or seeking innovative strategies to stay ahead, we
              deliver results-driven solutions that elevate your hotel to new
              heights. Let’s build your future in hospitality—together."
            </p>
