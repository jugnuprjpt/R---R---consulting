...
export default function ContactUs() {
  return (
    <>
      <Head>
        <title>Contact R & R Hotel Consultants | Ramesh Patel</title>
        <meta
          name="description"
          content="Get in touch with R & R Hotel Consultants for expert hospitality solutions. Contact R & R Hotel Consultants at +1-319-512-9039 or presidentialinn@gmail.com. Speak directly with Ramesh Patel for expert hospitality consulting solutions."
        />
        <meta
          name="keywords"
          content="contact hotel consultant, Ramesh Patel, hotel consultancy contact, hospitality consulting services"
        />
